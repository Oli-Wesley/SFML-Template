...
void GameSystem::start(const std::string &start_scene) {
    std::cout << "F1: Show scene_root Tree\n";
    std::cout << "F2: Show dont_destroy Tree\n";
    std::cout << "F3: Toggle Debug\n";
    std::cout << "F4: Show Registered Camera Layers\n";
    std::cout << "F5: Show All Files In AssetDatabase\n";
